    ...
    return (
      <div style={{ position: 'fixed', height: '100%', width: '100%', top: 0 }}>
        ...
        <TabBar.Item
            ...
            selectedIcon={<i style={{fontSize:22,lineHeight:'22px',color:'#3e3fc5'}} className='iconfont icon-gonglve'></i>
            }
          ...
          <TabBar.Item
            ...
            selectedIcon={<i style={{fontSize:22,lineHeight:'22px',color:'#3e3fc5'}} className='iconfont icon-buoumaotubiao02'></i>
            }
            title="社区"
            key="Community"
          ...
          <TabBar.Item
            ...
            selectedIcon={<i style={{fontSize:22,lineHeight:'22px',color:'#3e3fc5'}} className='iconfont icon-fenxiang'></i>
            }
            title="共享"
            key="Share"
          ...
          <TabBar.Item
            ...
            selectedIcon={<i style={{fontSize:22,lineHeight:'22px',color:'#3e3fc5'}} className='iconfont icon-wode'></i>
        }
            title="我的"
            key="My"
